...
Route::prefix('v1')->group(function ()  {
    ...
    Route::middleware('guest:api')->group(function () {
        ...
        Route::get('clients/{client}/history', 'ClientController@showHistory')->name('clients.history.show');
        ...
        Route::post('cars/trade/evaluate', 'CarController@tradeEvaluate')->name('cars.trade.evaluate');
    });
});
